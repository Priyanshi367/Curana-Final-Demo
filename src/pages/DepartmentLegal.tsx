...
import { Scale, Mail, Users as UsersIcon } from "lucide-react";

const legalTeamMembers = [
  { name: "Thomas Wilson", role: "Chief Compliance Officer" },
  { name: "Jennifer Adams", role: "Legal Counsel" },
  { name: "Amanda Roberts", role: "Department Head" },
];

const DepartmentLegal = () => {
  ...
  const HomeContent = () => (
    <div className="space-y-8">
      <Card className="p-8 border-l-4 border-l-rose-500">
        <div className="flex items-start gap-6">
          <div className="h-16 w-16 rounded-xl bg-rose-500 flex items-center justify-center flex-shrink-0">
            <Scale className="h-8 w-8 text-white" />
          </div>
          <div className="flex-1">
            <h2 className="text-3xl font-bold mb-2">Legal</h2>
            <p className="text-muted-foreground mb-6">
              Compliance, contracts, and regulatory affairs.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">Amanda Roberts</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">legal@curana.health</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div>
        ...
        <Card className="p-6">
          <p className="text-muted-foreground leading-relaxed">
            The Legal department ensures Curana Health operates in full compliance with all 
            applicable laws and regulations. We manage contracts, handle regulatory affairs, 
            and provide legal guidance to support the organization's mission while mitigating risks.
          </p>
        </Card>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Meet the talented professionals in our Legal department
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {legalTeamMembers.map((member, index) => (
          <Card key={index} className="p-4 hover:shadow-hover transition-shadow cursor-pointer">
            <div className="flex items-start gap-3">
              <div className="h-12 w-12 rounded-full bg-rose-100 flex items-center justify-center text-lg font-semibold text-rose-600 flex-shrink-0">
...
export default DepartmentLegal;
